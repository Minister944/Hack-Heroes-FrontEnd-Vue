    ...
    <div class="row no-gutters">
      <div class="col mb-3">
        <div class="card p-3">
            ...
            <div class="row">
              <div class="col-6">
                <img
                  ...
                  alt="auto"
                  style="max-width: 100%"
                  :src="getImgUrl(getuserProfile.lvl)"
                />
              </div>
              <div class="col-6">
                <strong>{{ getuserProfile.login }}</strong
                ><br />
          ...
          <div class="labeldata" style="padding-top: 10px">
            Umiesz już {{ this.ilosc_przerobionych_pytan1 }} pytania na
            {{ this.ilosc_wszystkich_pytan1 }}
          </div>
          <b-progress
            role="progressbar"
            :max="this.ilosc_wszystkich_pytan1"
            height="2rem"
          >
            <b-progress-bar
            ...
            >
              <span
                ><strong
                  >{{
                    (
                      (this.ilosc_przerobionych_pytan1 /
                        this.ilosc_wszystkich_pytan1) *
                      100
                    ).toFixed(2)
                  }}%</strong
          ...
          <div class="labeldata">
            Najlepszy czas egzaminu teoretycznego:
            {{ this.naj_wynik_z_test_teoretycznego }}
          </div>
          <div style="padding-top: 100px"></div>

          <h5>Podręcznik kierowcy</h5>
          <div class="pb-2 wiedz">
            <fa icon="ruler-vertical" class="m-2" style="min-width: 21px" />
            <div>
              Minimalna dopuszczalna głębokość bieżnika przez polskie prawo to
              1,6 mm.
            </div>
          </div>
          <div class="pb-2 wiedz">
            <fa icon="video" class="m-2" style="min-width: 21px" />
            <div>
              <a
                target="_blank"
                rel="”noreferrer”"
                href="https://www.youtube.com/watch?v=FJlGMFLhTos"
                >5 STRASZNYCH BŁĘDÓW młodego KIEROWCY</a
              >
            </div>
          </div>
          <div class="pb-2 wiedz">
            ...
            <div>
              <a
                target="_blank"
                rel="”noreferrer”"
                href="https://www.youtube.com/watch?v=nV7O8apBRZY"
                >Jak przygotowac auto na zimę</a
              >
            </div>
          </div>
          <div class="pb-2 wiedz">
            <fa icon="temperature-low" class="m-2" style="min-width: 21px" />
            <div>
              Zalecamy zmienić opony na zimowe, gdy średnia temperatura spadnie
              i pozostanie poniżej 7°C.
            </div>
          </div>
          <div class="pb-2 wiedz">
            <fa icon="video" class="m-2" style="min-width: 21px" />
            <div>
              <a
                target="_blank"
                rel="”noreferrer”"
                href="https://www.youtube.com/watch?v=dQf8U97tGoA"
                >JAK UMYĆ SAMOCHÓD POD DOMEM I NA MYJNI</a
              >
            </div>
          </div>
        </div>
          ...
          <div class="col mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <p>
                  Najlepsze czasy użytkowników, którzy rozwiązali egzamin
                  teoretyczny na 100%.
                </p>
                <div class="card-text">
                  <b-table
              ...
              <div class="card-body">
                ...
                <div class="container" style="flex-direction: row">
                  <div class="row justify-content-md-center">
                    <div
                      class="col col-lg-2 box p-0"
                      v-bind:class="{
                        actual: getuserProfile.lvl == n - 1,
                        unloc: getuserProfile.lvl > n - 1,
                      }"
                      v-for="n in 20"
                      :key="n"
                    >
                      <router-link
                        v-if="getuserProfile.lvl == n - 1"
                        to="/Learn"
                        type="button"
                      ...
                      >
                      <router-link
                        v-else-if="getuserProfile.lvl > n - 1"
                        :to="'/LearnOne/' + n"
                        type="button"
                        style="text-decoration: none; color: black"
                        class="linku"
                ...
                <div class="container" style="flex-direction: row">
                  <div class="row justify-content-md-center">
                    <div
                      class="col col-lg-2 box p-0"
                      v-bind:class="{ unloc: getuserProfile.lvl > n - 1 }"
                      v-for="n in 20"
                      :key="n"
                    >
                      <router-link
...
export default {
  ...
  data() {
    return {
      ...
      items: [{ login: "", ilosc_punktow: "", czas: "" }],
    };
  },
  components: {},
  computed: {
  ...
  methods: {
    async gettatistic() {
      ...
      try {
        if (response.data.naj_wynik_z_test_teoretycznego == "brak")
          this.naj_wynik_z_test_teoretycznego = "Brak";
        else {
    ...
    async getranking() {
      ...
      if (response.data.ranking.length > 5) {
        var dlug = 5;
      ...
      for (var i = 0; i < dlug; i++) {
        ...
        this.items[i] = {
          czas: minLeft + ":" + sLeft,
          id: i + 1,
          login: response.data.ranking[i].login,
        };
      }
